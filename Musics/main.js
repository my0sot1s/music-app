module.exports = () => {
    ...
    var music = [
        {
            name: "Breakbot",
            background: "https://i.imgur.com/qulTs9Y.jpg",
            songs: [
                {
                    title: "Star Tripper",
                    album: "Still Waters",
        ...
        {
            name: "The Beatles",
            background: "https://i.imgur.com/EVFoKs4.jpg",
            songs: [
                {
                    title: "Something",
                    album: "Abbey Road",
        ...
        {
            name: "Daft Punk",
            background: "https://i.imgur.com/oTnan43.jpg",
            songs: [
                {
                    title: "Giorgio",
        ...
        {
            name: "Pink Floyd",
            background: "https://i.imgur.com/qRYQmrD.jpg",
            songs: [
                {
                    title: "Marooned",
        ...
        {
            name: "Andy Allo",
            background: "https://i.imgur.com/p9UrDBv.jpg",
            songs: [
                {
        ...
        {
            name: "Jamiroquai",
            background: "https://i.imgur.com/P94ySQQ.jpg",
            songs: [
                {
        ...
        },
        {
            ...
            background: "https://i.imgur.com/kQUxrc5.jpg",
            songs: [
                {
        ...
        {
            name: "Soda Stereo",
            background: "https://i.imgur.com/8qHq5yl.jpg",
            songs: [
                {
